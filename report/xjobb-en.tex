...
Primarly the focus is to measure and analyse those according to their solving potential.
...
As one can see there is a quite small time intervall at which most puzzles are solved.
...
The backtrack algorithm may similarly be studied in more detail by adding additional variations to it, which primarly includes how it chooses which square to start each search tree with.
