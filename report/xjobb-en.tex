...
This method is very similar to how humans solve Sudoku and the rules used is in fact derived from human solving methods.
    ...
    Modeling a Sudoku by using a constraint solving artificial neural network.
...
Two different parameter settings were simulated and the results demonstrates the differences.
...
Following the interval of critical temperatures there were no puzzles being solved within the limit of 20 seconds.
...
%TODO DAVID
%Känner inte att jag har stenkoll på parallelisering så du får gärna gå igenom denna sektion
%Extra noga för att se om det finns bristande resonemang etc.
...
\\
%TODO DAVID
%Vill minnas att du har sagt att det går utmärkt att parallelisera neurala nätverk
%Men är definitivt bäst om du skriver om detta
The Boltzmann machine is also parallelizable.
This can be done by %blargh blargh
\\
...
%TODO:
%Här skulle vi kanske kunna inkludera information om vilken kompilator/kompileringsflaggor som användes eftersom denna section ju framförallt är till för att göra så att andra kan återupprepa våra resultat.
%Vi skulle också kunna skriva att koden är tillgänglig via request också. Och att man typ får använda koden hur man vill
