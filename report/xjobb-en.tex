...
Section 2.1 is devoted to explaining the test setup which includes hardware specifications but also an overview picture of the setup. 
Section 2.2 focuses on how and what aspects of the algorithms where analysed.
Section 2.3 explains the process of choosing test data.
The last subsection 2.4 gives an overview of the statistical analyses which was performed on the test data.
